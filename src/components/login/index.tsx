...
const Login = () => {
  ...
  let substrateName: any;
  let substrateAddress: any;
  const getSubstrateAddressvalue = (e: any) => {
              ...
              <div className="inline-block align-bottom p-0.5 rounded-lg bg-gradient-to-br from-W3G1  via-W3G2 to-W3G3 text-left overflow-hidden shadow-xl transform transition-all sm:y-8 sm:align-middle   ">
                <div className="bg-black px-4 py-5 sm:px-6 lg:px-12 rounded-md sm:p-6 lg:p-12">
                  <div className="flex justify-between text-xl font-light	">
                    ...
                    <button
                      onClick={close_wallet_list}
                      className="fa fa-times text-white text-2xl "
                      aria-hidden="true"
                    ></button>
                  </div>
                  ...
                  <button
                    onClick={loginMeatMask}
                    className="bg-neutral-700 text-white flex justify-between  p-4 rounded-lg w-full my-8"
                  >
                  ...
                  <button className="bg-neutral-700 flex justify-between text-white p-4 rounded-lg w-full my-8">
                    ...
                    <div>
                      <img
                        className="w-8 h-8"
                        src="https://portal.web3games.org/icon-wallet-walletconnect.svg"
                        alt=""
                      />
                    </div>
                  </button>
                  <button
                    onClick={loginsubstrate}
                    className="bg-neutral-600 flex justify-between text-white p-4 rounded-lg w-full my-8"
                  >
                    <div className="text-lg font-semibold">Polkadotjs</div>
                    <div>
                      <img
                        className="w-8 h-8 rounded-lg"
                        src="https://cdn.discordapp.com/attachments/876498266550853642/908665467273613392/unknown.png"
                        alt=""
                      />
                    </div>
                  </button>
              ...
              <div className="inline-block align-bottom p-0.5 rounded-lg bg-gradient-to-br from-W3G1  via-W3G2 to-W3G3 text-left overflow-hidden shadow-xl transform transition-all sm:align-middle   ">
                <div className="bg-black px-4 py-5 sm:px-6 lg:px-12 rounded-md sm:p-6">
                  <div className="flex justify-end text-xl">
                    <button onClick={rechoose_substrate_address} className="fa fa-times " aria-hidden="true"></button>
                  </div>
                  ...
                  {SubstrateAddressList.map((item: any) => (
                    <div
                      key={item.address}
                      onClick={getSubstrateAddressvalue}
                      className=" flex justify-between px-5 py-3 sm: border-t items-center"
                    >
          ...
          <div className="flex items-center justify-center min-h-screen pt-4 px-4  text-center sm:block sm:p-0">
            ...
            >
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:y-8 sm:align-middle   sm:p-6 ">
                <div>
                  <div className="flex justify-end text-xl">
                    <button onClick={substrate_wallet_install} className="fa fa-times " aria-hidden="true"></button>
                  </div>
                  ...
                  <div className="mt-3 px-5 sm:mt-5 border-t ">
                    <div className="flex my-3 justify-center ">
                      ...
                      <a className="text-blue-400 ml-0.5" href="https://polkadot.js.org/extension/">
                        here
                      </a>
                      .
                    </div>
                    <Dialog.Title as="h3" className="mt-3 text-center text-lg leading-6 font-medium text-gray-900">
                      <button onClick={loginsubstrate}>
                        <div className="flex justify-center">
                          ...
                          <div className="text-center mt-1.5 text-xl">
                            <i className="ml-10  fa fa-arrow-right" aria-hidden="true"></i>
                          </div>
                        </div>
                      </button>
                    </Dialog.Title>
          ...
          <div className="flex items-center justify-center min-h-screen pt-4 px-4  text-center sm:block sm:p-0">
            ...
            >
              <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:y-8 sm:align-middle   sm:p-6 ">
                <div>
                  <div className="flex justify-end text-xl">
                    <button onClick={metamask_install} className="fa fa-times " aria-hidden="true"></button>
                  </div>
                  ...
                  <div className="mt-3 px-5 sm:mt-5 border-t ">
                    <div className="flex my-3 justify-center ">
                      Download MeatMask Extension
                      <a className="text-blue-400 ml-0.5" href="https://metamask.io/download/">
                        here
                      </a>
                      .
                    </div>
                    <Dialog.Title as="h3" className="mt-3 text-center text-lg leading-6 font-medium text-gray-900">
                      <button onClick={loginMeatMask}>
                        <div className="flex justify-center ">
                          <img
                            className="w-10 h-10"
                            src="https://portal.web3games.org/icon-wallet-metamask.svg"
                            alt=""
                          />
                          <h1 className="ml-2 mt-2">Try Again</h1>
                          <div className="text-center mt-1.5 text-xl">
