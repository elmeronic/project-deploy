...
const Pop_up_box = () => {
  ...
  useEffect(() => {
    ...
    const Pop_up_box: any = document.getElementById('SwapSuccessPop_up_box');
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3 w-0 flex-1 pt-0.5 text-white text-sm">
                  <p className="font-medium">
                    {pop_up_boxData.type} {classNames(pop_up_boxData.state ? 'Success' : 'Failed')}
                  </p>
                  <p className={pop_up_boxData.state ? 'hidden' : 'mt-1 '}>Please try again</p>
                  <div className={pop_up_boxData.hash == '' ? 'hidden' : ''}>
                    <Link
                      passHref
                      href={`https://explorer-devnet.web3games.org/blocksdetails/${pop_up_boxData.hash}`}
                      legacyBehavior
                    >
